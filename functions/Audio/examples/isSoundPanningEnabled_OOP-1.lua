local function testPanning()
    ...
    local sound = Sound3D("xy.mp3", 0, 0, 0)
    outputChatBox("By default, the sound has its panning " .. (sound.panningEnabled and "enabled" or "disabled"))
    -- Disable the panning and ouput a fact
    sound.panningEnabled = false
